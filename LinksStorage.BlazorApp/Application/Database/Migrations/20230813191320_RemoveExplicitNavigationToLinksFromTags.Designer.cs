...
namespace LinksStorage.BlazorApp.Application.Database.Migrations
{
    ...
    [Migration("20230813191320_RemoveExplicitNavigationToLinksFromTags")]
    partial class RemoveExplicitNavigationToLinksFromTags
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LinkTag", b =>
                {
                    b.HasOne("LinksStorage.BlazorApp.Application.Models.Link", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_link_tag_links_link_id");
